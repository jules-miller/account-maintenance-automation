...
class TestFilterData(unittest.TestCase):
	...
	def test_FilterUsersAll(self):
		excludedUsers = ['User2@domain', 'user4@domain']
		flaggedUsers = ['user5@domain']
		activeUsers = ['user1@domain']
		inactiveUsers = ['user1@domain', 'user2@domain', 'user3@domain', 'user4@domain', 'user5@domain', 'user6@domain']
		expectedResult = ['user3@domain', 'user6@domain']
	...
	def test_DedupeList(self):
		value = ['user1@domain', 'user2@domain', 'user3@domain', 'user3@domain', 'user5@domain', 'user6@domain', 'user6@domain']
		expectedResult = ['user1@domain', 'user2@domain', 'user3@domain', 'user5@domain', 'user6@domain']
	...
	def test_FormatSQL2(self):
		users = ['user1@domain', "user'2@domain", "user'3@domain"]
		expectedResult = "'user1@domain','user''2@domain','user''3@domain'"
		result = FilterData.FormatSQL(users)
		self.assertEqual(result, expectedResult)
